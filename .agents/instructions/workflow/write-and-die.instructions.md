...
This is the operational form of the Worker capability boundary defined in spec `1b654f30` ("Two-tier Planner/Worker model routing architecture"), which states plainly:
