...
- **Critique**: review the current state the way [review.agent.md](https://github.com/mankinskin/context-engine/blob/main/.agents/agents/review.agent.md) critiques an implementation.
