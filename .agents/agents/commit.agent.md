...
- Identify generated files that need regeneration before staging (see [generated-files.instructions.md](../instructions/repository/generated-files.instructions.md)).
