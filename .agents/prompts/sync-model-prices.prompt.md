...
Reference [model-prices.instructions.md](../../session/.agents/instructions/orchestration/model-prices.instructions.md) for the table shape, tooling surface, and staleness policy. The routing rules to reconcile live in [model-routing.instructions.md](../instructions/workflow/model-routing.instructions.md) and [orchestrator-delegation.instructions.md](../instructions/workflow/orchestrator-delegation.instructions.md).
