# Session Objective
Resolve the current file_length batch for viewer-api and reduce 7 findings from the baseline.

# Scope Guardrails
- Stay inside viewer-api unless a blocker requires a dependency fix outside scope.
